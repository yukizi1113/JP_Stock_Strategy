...
def main():
    ...
    bt.plot(save_path=os.path.join(args.out_dir, "07_black_litterman_result.png"))
    result.to_csv(os.path.join(args.out_dir, "07_black_litterman_portfolio.csv"))

    results_dir = os.path.join(ROOT, "results")
    os.makedirs(results_dir, exist_ok=True)
    with open(os.path.join(results_dir, "07_black_litterman_stats.json"), "w", encoding="utf-8") as f:
